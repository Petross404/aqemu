	...
	: QDialog( parent )
{
	...
	ui.Edit_Thanks_To_Text->setHtml( tr(
		...
		"<br>Denis Smirnov (aka reMiND) - Arch Linux Package and Other "
		"Help\n"
		...
		"<br>Alexander Romanov (aka romale) - Testing, New Ideas and Other "
		"Help\n"
		"<br>Timothy Redaelli - Patch for CMake\n"
		"<br>Pavel Serebryakov (aka Kronoph) - Correcting English "
		"translation\n"
		...
		"<br><br><b>Thanks all www.nclug.ru group for testing and "
		"suggestions for improvement.</b>\n"
...
void About_Window::Show_Links_File()
{
	...
	if ( QFile::exists( linksFilePath ) ) { show_url = linksFilePath; }
