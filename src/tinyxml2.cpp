...
char* XMLNode::ParseDeep( char* p, StrPair* parentEndTag, int* curLineNumPtr )
{
	...
	while ( p && *p )
	{
		...
		if ( decl )
		{
			...
			//
			// Optimized due to a security test case. If the first node
			// is a declaration, and the last node is a declaration,
			// then only declarations have so far been added.
