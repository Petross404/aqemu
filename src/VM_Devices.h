...
public:
	...
	static QString Accel_To_String( Machine_Accelerator accel )
	{
		switch ( accel )
		{
			case KVM: return "kvm"; break;
			case XEN: return "xen"; break;
			case TCG: return "tcg"; break;
			default: return "";
		}
	}
	...
	public:
		...
		Sound_Cards()
		{
			Audio_sb16 = Audio_es1370 = Audio_Adlib = Audio_PC_Speaker =
		...
		bool isEnabled()
		{
			return ( Audio_sb16 || Audio_es1370 || Audio_Adlib
				 || Audio_PC_Speaker || Audio_GUS || Audio_AC97
				 || Audio_HDA || Audio_cs4231a );
		}

		bool operator==( const Sound_Cards &v ) const
		{
			if ( Audio_sb16 == v.Audio_sb16 && Audio_es1370 == v.Audio_es1370
			     && Audio_Adlib == v.Audio_Adlib && Audio_PC_Speaker == v.Audio_PC_Speaker
			     && Audio_GUS == v.Audio_GUS && Audio_AC97 == v.Audio_AC97
			     && Audio_HDA == v.Audio_HDA && Audio_cs4231a == v.Audio_cs4231a )
			{
				return true;
			}
			else { return false; }
...
public:
	...
	VM_Storage_Device( bool		  enabled,
			   const QString &file_name,
			   bool		  Native_mode,
			   const VM_Native_Storage_Device &device );	// FIXME test const VM_Native_Storage_Device &device IN OLD version without const
...
private:
	...
	bool _Use_MAC, _Use_VLAN, _Use_Name, _Use_Hostname, _Use_File_Descriptor,
		...
		_Use_TUN_TAP_Down_Script, _Use_Bridge_Helper, _Use_Listen,
		_Use_Connect, _Use_MCast, _Use_Sock, _Use_Port, _Use_Group,
		_Use_Mode, _Use_File, _Use_Len, _Use_Addr, _Use_Vectors, _Use_Net,
		_Use_Host, _Use_Restrict, _Use_DHCPstart, _Use_DNS, _Use_Tftp,
		_Use_Bootfile, _Use_HostFwd, _Use_GuestFwd, _Use_SMB,
		_Use_SMBserver, _Use_Sndbuf, _Use_VNet_hdr, _Use_VHost, _Use_VHostFd;
};
...
public:
	...
	void Get_USB_QEMU_Devices( bool &keyboard,
				   bool &mouse,
				   bool &tablet,
				   bool &wacomTablet,
				   bool &braille ) const;
	void Set_USB_QEMU_Devices(
		bool keyboard, bool mouse, bool tablet, bool wacomTablet, bool braille );
