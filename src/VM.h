...
public:
	...
	bool Create_Template( const QString &vm_path,
	...
	QStringList Build_Shared_Folder_Args( VM_Shared_Folder folder,
					      int	       id,
					      bool Build_QEMU_Args_for_Script_Mode );
...
private slots:
	...
	void Save_VM_Native_Storage_Device( TXML2QDOM::QDomDocument &New_Dom_Document,
...
private:
	...
	int native_device_count;    // to keep track of the number of native devices
