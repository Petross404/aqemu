		...
		for ( int fx = 0; fx < 32; ++fx )
		{
			     ...
			     == "folder" + QString::number( fx ) )
			{
				...
				ui.Label_Connected_To->setText(
					...
					+ "; mount -t 9p -o trans=virtio shared"
					+ QString::number( fx ) + " /tmp/shared"
...
void Folder_Sharing_Widget::on_Folders_List_currentItemChanged( QListWidgetItem *current,
