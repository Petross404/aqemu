...
My_List_Widget::My_List_Widget( QWidget* parent )
	: QListWidget( parent )
{}
				  ...
				  bool			erase_parent_margins )
{
	...
	if ( erase_margins ) l->setContentsMargins( 0, 0, 0, 0 );
	...
	{
		list->addItem( new QListWidgetItem( tab_widget->tabIcon( i ),
	...
	{
		if ( erase_margins ) stack->setContentsMargins( 0, 0, 0, 0 );
	}
}
